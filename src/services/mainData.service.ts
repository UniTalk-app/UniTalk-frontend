...
class MainData {
    ...
    getData = async (): Promise<void> => {
        try{
            ...
            const userGroups = await axios.get(BackendAPI.getGroups, {
                headers: authHeader()
            }); 
            this.__usergroups = userGroups.data._embedded.groupList;
